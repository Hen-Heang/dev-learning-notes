...
import { ChevronLeft, Calendar, Clock, ShieldCheck, Share2 } from "lucide-react";
    ...
    <>
      ...
      <PageTransition>
        <div className="flex justify-center max-w-[1440px] mx-auto min-h-screen">
                ...
                <div className="mb-16">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-8 mb-12">
                    ...
                    <div className="flex items-center gap-4">
                      <button className="p-2.5 rounded-xl bg-zinc-900 border border-zinc-800 text-zinc-500 hover:text-emerald-400 hover:border-emerald-500/30 transition-all active:scale-95">
                        <Share2 size={18} />
                      </button>
          ...
          {!isEditing && (
            <div className="hidden xl:block py-16 px-8 sticky top-0 h-screen overflow-hidden w-80">
              <div className="p-8 rounded-[2rem] bg-zinc-950/40 backdrop-blur-xl border border-zinc-800/60 h-full overflow-y-auto">
