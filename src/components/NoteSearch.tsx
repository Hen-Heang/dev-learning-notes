  ...
  return (
    <div>
      ...
      <div className="relative mb-10 group">
        ...
        <div className="relative flex items-center bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-2xl px-4 py-4 transition-all duration-300 group-focus-within:border-zinc-700 group-focus-within:bg-zinc-900 shadow-2xl">
          <Search
            size={18}
            className="text-zinc-500 group-focus-within:text-emerald-400 transition-colors mr-3"
          />
          <input
            type="text"
            value={query}
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-1 px-2 py-1 rounded-md bg-zinc-800/50 border border-zinc-700/50 text-[10px] font-mono text-zinc-500">
              <Command size={10} />
              <span>K</span>
            </div>
          </div>
